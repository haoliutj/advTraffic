...
def get_opts_wf(mode,Adversary,classifier_type):
    ...
    return {
        # 'train_data_path': '../data/wf/train_NoDef_burst.csv', # "setting for self-build cnn and lstm models"
        'train_data_path': '../data/wf/with_validation/train_NoDef_burst.csv', #  "setting for other models (DF-CNN) etc"
...
def get_opts_wf_ow(mode,Adversary,classifier_type):
    return {
        # 'train_data_path': '../data/wf_ow/train_NoDef_mix.csv',   # without validation for self build cnn lstm
...
if __name__ == '__main__':
    ...
    adveraries = ['DeepFool','PGD']                #['FGSM','DeepFool','PGD','GAN']
    mode = 'wf_ow'                     # ['wf','shs','wf_ow','wf_kf','wf_sg']
