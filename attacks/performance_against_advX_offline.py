...
class against_adv_x:
    ...
    def test_model(self):
        ...
        if self.opts['cross_validation']:
            ...
            #     adv_test_data_path = '../data/' + self.mode + '/DF-CNN/' + self.opts['adv_test_data_path']
            else:
                print('classifier type should in [lstm,cnn]. System will exit!')
                sys.exit()
        # test on Walkie-Talkie defended data
        elif self.opts['Adversary'] == 'WT':
            adv_test_data_path = '../data/WalkieTalkie/cw/defended_csv/adv_test_WT.csv'
        else:
        ...
        if self.mode == 'wf' or 'wf_ow' or 'wf_kf':
            ...
            elif self.classifier_type == 'DF-CNN' or self.classifier_type == 'DF-CNN/DF-CNN_source_data':
...
if __name__ == '__main__':
    ...
    Adversary = ['FGSM']    # 'FGSM','DeepFool','PGD','GAN', "WT" (walkietalkie), 'Mockingbird','WTFPAD'
    mode = 'wf'                                # ['wf','shs','wf_ow','kf_kf]
